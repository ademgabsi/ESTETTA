...
if (
    ...
    if (
        ...
        if (isset($_FILES["lesson_video"]) && !empty($_FILES['lesson_video']) && !empty($_FILES['lesson_video']['name'])) {
            ...
            $video_foldertoSave = $lessonC->showLesson($_GET['lesson_id'])['lesson_video'];
        }
        ...
        $lesson = new Lesson(
            ...
            $video_foldertoSave,
            $lessonC->showLesson($_GET['lesson_id'])['course_id']
        );
        var_dump($lesson);

        $lessonC->modifierLesson($lesson, $_GET['lesson_id']);

        header('Location: lessons.php?course_id=' . $lessonC->showLesson($_GET['lesson_id'])['course_id']);
...
<body>
    ...
    <section class="header">
        ...
        if (isset($_GET['lesson_id'])) {
            $oldLesson = $lessonC->showLesson($_GET['lesson_id']);
            ?>
                ...
                <form class="register" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex">
                        <div class="col">
                            ...
                            <input type="text" name="lesson_name" placeholder="Enter your Lesson Name" maxlength="50"
                                value="<?php echo $oldLesson['lesson_name']; ?>" required class="box">
                        ...
                        <div class="col">
                            ...
                            <input type="file" name="lesson_video" id="lesson_video" class="box">
                        </div>
                    ...
                    <div class="col">
                        ...
                        <textarea type="text" name="lesson_description" id="lesson_description" maxlength="255" required
                            class="box">
                                            <?php echo $oldLesson['lesson_description']; ?>
                                            </textarea>
                    </div>
                    <div id="error">
                        <?php echo $error; ?>

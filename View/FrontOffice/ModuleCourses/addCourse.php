...
if (
    ...
    if (
        ...
        $CourseC->ajouterCourse($newCourse);
                ...
                <div class="flex">
                    <div class="col">
                        ...
                        <input type="text" name="course_author" id="course_author" maxlength="50"
                            placeholder="Enter Course Author" required class="box">
                    </div>
                    <div class="col">
                        <p>Course Duration <span>*</span></p>
                        <input type="number" name="course_duration" id="course_duration"
                            placeholder="Enter Course Duration" maxlength="20" required class="box">

                        <p>Course Image: <span>*</span></p>
                        <input type="file" name="course_img" id="course_img" required class="box">
                    </div>

                </div>
                <div class="col">
                    <p>Course Description <span>*</span></p>
                    <textarea type="text" name="course_desc" id="course_desc" maxlength="255"
                        placeholder="Enter Course Description" required class="box">
                        </textarea>
                </div>
                <div id="error">
                    <?php echo $error; ?>

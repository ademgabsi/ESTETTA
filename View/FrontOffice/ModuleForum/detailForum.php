...
$forum = $forumC->getForumById($_GET['id_forum']);
$allComment = $replyForumC->getAll();
    ...
    <main class="cd__main">
        ...
        <div class="container">
            <div class="response-group">
                <div class="header-forum-action">
                    <h3>FORUM</h3>
                    <a href="addForum.php" class="button button--approve header-forum-action-add">
                        <i class="fa fa-plus solid"></i>
                    </a>
                </div>


                <div class="devider-forum"></div>
                <div class="response">
                    <h1 class="response__title">
                        <?= $forum['title'] ?>
                    </h1>
                    <?php if($connectedUser['id']==$forum['id_user']){ ?>

                    <a href=<?= "deleteForum.php?forum_id=" . $forum['id'] ?>
                        class="button button--deny button-delete-forum">
                        </i><i class="fa fa-trash solid"></i>
                    </a>
                    <?php } ?>
                    ...
                    <div class="post-group">
                        <div class="post post--commenting">
                            <p class="post__body">
                                <?= $forum['content'] ?>
                            ...
                            <div class="post__actions">
                                ...
                                <div class="post__comments">
                                    ...
                                    foreach ($allComment as $comment) {
                                        if ($comment['id_forum'] == $forum['id']) {
                                            $commentUser = $userC->getById($comment['id_user']);


                                            ?>
                                            <div class="comment-group" >
                                                <div class="post" style="position:relative;">
                                                    <img class="post__avatar comment__avatar" src=<?= $commentUser["image"] ?>
                                                ...
                                                <a href=<?= "deleteReply.php?id_forum=" . $forum['id'] . "&id=" . $comment['id'] ?>
                                                    class="button button--deny button-delete-forum">
                                                    </i><i class="fa fa-trash solid"></i>
                                                </a>
                                                <?php }?>
                                    ...
                                    ?>
                                    <form method="POST" action=<?= "addReply.php?id_forum=" . $forum['id'] ?>
                                        class="comment-form">
                                        <img class="comment-form__avatar" src=<?= $connectedUser["image"] ?> alt=""
                                            width="100" height="100">


                                        <textarea name="content" required></textarea>
                                        <div class="comment-form__actions">
                                            <div class="button button--light ">Cancel</div>
                                            <input type="submit" name="submit_comment_forum"
                                                class="button button--confirm" value="Comment" />
                                        </div>
                                    </form>
                                </div>
                            </div>

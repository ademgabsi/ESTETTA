                        ...
                        <div class="post-group">
                            <div class="post ">
                                ...
                                <div class="post__actions">
                                    ...
                                    <a href=<?= "detailForum.php?id_forum=" . $forum['id'] ?>
                                        class="button button--fill comment-trigger">
                                        <span>Comment...</span>
                                    </a>
                                    <a href=<?= "detailForum.php?id_forum=" . $forum['id'] ?> class="button button--flag">

...
$oldRec = $reclamationC->getById($_GET['rec_id']);
...
if (
    ...
    if (
        ...
        $reclamationC->modifierRec($newRec);
    ...
    <section class="header">
        ...
        <section class="form-container">
            <form class="register" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="col">
                    <p>Title <span>*</span></p>
                    <input value=<?= $oldRec["nom"] ?> type="text" name="nom" placeholder="Enter Title" maxlength="50"
                        required class="box">
                </div>
                <div class="col">
                    <p>Subject <span>*</span></p>

                    <select name="sujet" id="sujet" required class="box" value=<?= $oldRec["sujet"] ?>>

...
<body>
    ...
    <section class="cards-container">
        <article class="card color-primary-1">
            <a href="ModuleCourses/listAdmin.php" class="details">
                <h2>Courses<h2>
            </a>
        </article>
        <article class="card color-primary-2">
            <a href="ModuleLessons/listAdmin.php" class="details">
                <h2>Lessons<h2>
            </a>
        </article>
        <article class="card color-primary-3">
            <a href="ModuleEvent/listAdmin.php" class="details">
                <h2>Events<h2>
            </a>
        </article>
        <article class="card color-primary-3">
            <a href="ModuleParticipants/listAdmin.php" class="details">
                <h2>Participants<h2>
            </a>
        </article>
        <article class="card color-primary-1">
            <a href="ModuleForum/listAdmin.php" class="details">
                <h2>Forum<h2>
            </a>
        </article>
        <article class="card color-primary-2">
            <a href="ModuleReclamation/listAdmin.php" class="details">
                <h2>Reclamation<h2>
            </a>
        </article>
    </section>

...
$allCourses = $lessonC->afficherLesson();
?>
...
<body>
    ...
    <table border="1" align="center" width="70%">
        <tr>
            <th>id</th>
            <th>lesson_name</th>
            <th>lesson_description</th>
            <th>lesson_video</th>
            <th>Butoon Delete</th>
        </tr>

        <?php
        foreach ($allCourses as $LessonC) {
            ?>
            <tr>
                <td>
                    <?= $LessonC['lesson_id']; ?>
                ...
                <td>
                    <?= $LessonC['lesson_description']; ?>
                </td>
                <td>
                    <?= $LessonC['lesson_video']; ?>
                </td>


                <td>
                    <a href="delete.php?id=<?php echo $LessonC['lesson_id']; ?>">Delete</a>
                </td>

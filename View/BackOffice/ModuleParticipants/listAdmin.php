...
$allCourses = $reservationC->listReservation();
?>
...
<body>
    ...
    <table border="1" align="center" width="70%">
        ...
        <?php
        foreach ($allCourses as $reservationC) {
            ?>
            <tr>
                <td>
                    <?= $reservationC['reservation_id']; ?>
                </td>
                <td>
                    <?= $reservationC['name_res']; ?>
                </td>
                <td>
                    <?= $reservationC['event_id']; ?>
                </td>
                <td>
                    <?= $reservationC['phone_res']; ?>
                </td>
                <td>
                    <?= $reservationC['message_res']; ?>
                </td>

                <td>
                    <a href="delete.php?id=<?php echo $reservationC['reservation_id']; ?>">Delete</a>
                </td>

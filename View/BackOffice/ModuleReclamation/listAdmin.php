...
$allCourses = $reclamationC->afficherRec();
?>
...
<body>
    ...
    <table border="1" align="center" width="70%">
        ...
        <?php
        foreach ($allCourses as $reclamationC) {
            ?>
            <tr>
                <td>
                    <?= $reclamationC['id']; ?>
                ...
                <td>
                    <?= $reclamationC['message']; ?>
                </td>

                <td>
                    <a href="delete.php?id=<?php echo $reclamationC['id']; ?>">Delete</a>
                </td>

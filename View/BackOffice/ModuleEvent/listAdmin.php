...
$allCourses = $evenementC->listevent();
?>
...
<body>
    ...
    <table border="1" align="center" width="70%">
        ...
        <?php
        foreach ($allCourses as $evenementC) {
            ?>
            <tr>
                <td>
                    <?= $evenementC['event_id']; ?>
                ...
                <td>
                    <?= $evenementC['creator_id']; ?>
                </td>
                <td>
                    <?= $evenementC['host_name']; ?>
                </td>
                <td>
                    <?= $evenementC['discription']; ?>
                </td>
                <td>
                    <?= $evenementC['event_image']; ?>
                </td>
                <td>
                    <?= $evenementC['event_date']; ?>
                </td>
                <td>
                    <?= $evenementC['price']; ?>
                </td>
                ...
                <td>
                    <a href="delete.php?id=<?php echo $evenementC['event_id']; ?>">Delete</a>
                </td>
